...
my_col = ['#3a5cbc', '#9291be', '#c15451', '#6F99AD', '#DF8F44',
'#80796B']
...
# Adjust the legend
ax.legend(fontsize=7, loc='upper left', bbox_to_anchor=(1, 0.6), title="Critic Score Platforms")
...
plt.text(
    x = 0.85, y = -0.4,  # Adjust x, y to position the caption below 
